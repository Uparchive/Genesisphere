...
export const Astra1={
 ...
 profile:Object.freeze({
  name:"Astra-1",entityKey:"astra-1",kind:"planet",earthLike:true,
 ...
 create(engine,relations={}){return engine.create("cosmic.terrestrial-planet",{...this.profile,...relations})}
};
